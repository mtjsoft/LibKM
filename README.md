...
## 1、介绍
kotlin-mvvm 组件化快速开发框架 [去除 DataBinding 版本](https://gitee.com/mtj_java/LibKM/)
...
```
dependencies {
	        implementation 'com.gitee.mtj_java:LibKM:1.1.0'
	}
...
以 app 中的 TestDataActivity 、TestDataViewModel 、activity_test.xml为例
...
```
class TestDataActivity : BaseActivity<TestDataViewModel>() {
...
BaseActivity是一个抽象类，有一个泛型参数，TestDataViewModel继承BaseViewModel作为泛型约束。

### 6.2、继承 BaseViewModel
